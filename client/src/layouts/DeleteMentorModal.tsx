...
const DeleteMentorModal = ({ isOpen, setIsOpen }: DeleteModalProps) => {
    ...
    const deleteMentor = (value: string) => {
        fetch("/api/deleteMentor/", {
            method: "delete",
            headers: {
