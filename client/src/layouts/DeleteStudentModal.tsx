...
const DeleteStudentModal = ({ isOpen, setIsOpen }: DeleteModalProps) => {
    ...
    const deleteStudent = (value: string) => {
        ...
        >
            <div className="px-12 py-10 flex-col">
                <div className="font-grotesk flex justify-between">
                    <div className="font-bold text-2xl">Delete Student</div>
