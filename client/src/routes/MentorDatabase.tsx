      ...
      <div className="flex mx-20 mt-16 gap-2">
        ...
        <div className="w-3/4">
          <div className="flex items-center justify-between">
            <div className="font-bold text-5xl font-grotesk">Find a Mentor</div>
            <div
              className="w-30 h-9 cursor-pointer bg-brand-gray-20 text-white font-medium px-8 py-[5px] rounded"
          ...
          <table className="mt-16 w-full px-20 table-fixed font-circular-std">
            <thead>
              <tr className="border-y border-black">
                ...
                <th className="text-left py-2 px-8 font-semibold">Sport</th>
                <th className="text-left py-2 pr-16 font-semibold">Major</th>
              </tr>
            </thead>
            <tbody>
              {mentors.map((mentor) => {
        ...
        <div className="w-1/4 pl-2">
          <div className="font-bold text-2xl font-grotesk">Search & Filter</div>
